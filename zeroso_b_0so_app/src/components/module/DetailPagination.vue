...
<script>
    export default {
        props:['listApi','apiKey','listData','isNewSystem','noResellerCompanyId'],
        data() {
            return {
                queryId:'',
                detailIndex: -1,
        ...
        methods: {
            ...
            getNewSystemAllList(pageNum,callback) {
                ...
                query['pageRequest.page'] = pageNum || (query.pageNum ? query.pageNum*1 : 1);
                query['pageRequest.perPage'] = query.pageSize ? query.pageSize*1 : self.$store.state.paginationPageSize;

    ...
    <div id="" class="flex-box-column related-email-list">
        <div class="container-control flex-item">
            ...
            <div class="table-control clearfix">
                <div class="control-btns" style="font-size: 14px;">
                    ...
                    <span class="margin-right-20" v-if="data.inquiryName">
                        ...
                        <router-link class="blue" target="_blank"
                                     :to="'/inquiry-price/all/detail?id='+data.inquiryName">{{data.inquiryName}}</router-link>
                    </span>
                    ...
                    <span class="margin-right-20"
                        ...
                        <span>供应商：</span>
                        <router-link class="blue" target="_blank"
                                     :to="'/partner/detail?id='+data.supplier_company.account_company_id">{{data.supplier_company.company_name}}</router-link>
                    </span>
                    <span class="margin-right-20"
                          v-if="data.customer_company && data.customer_company.account_company_id">
                        <span>客户：</span>
                        <router-link class="blue" target="_blank"
                                     :to="'/partner/detail?id='+data.customer_company.account_company_id">{{data.customer_company.company_name}}</router-link>
                    </span>
                        ...
                        <template slot-scope="scope">
                            <div class="email-detail">
                                <div class="detail-base-body">
                                    ...
                                    <div class="email-content" v-html="scope.row.message_body_html"></div>
...
<script>
    ...
    import EmailDetailAddAddress from "./../email/component/email-detail-add-address";
    import OrderUtils from "../order/order-utils";

    export default {
        components: {EditEmail, EmailDetailAddAddress},
        data() {
            return {
                data: {},
                module_id: '',

<template>
    <div class="flex-box-column related-message-detail" v-loading="loading">
        <el-card>
            ...
            <div style="position: relative;">
                <div class="related-message-detail-list" id="related-message-detail-list">
            ...
            <div class="message-send">
                ...
                <el-input type="textarea" v-model="sendMessage" :rows="8"></el-input>
...
<script>
    ...
    export default {
        components: {RelatedMessageDetailDeleteTag, RelatedMessageDetailAddTag, RelatedMessageDetailForward},
        data() {
            return {
                loading: false,
                orderName: null,
        ...
        methods: {
                ...
                self.$http({
                    ...
                    success: function (data) {
                        ...
                        if (data.msg) {
                            ...
                            if (self.$route.query.inquiryQuotationId) {
                            ...
                            }else if (self.$route.query.inquiryId) {
            ...
            getInquiryQuotationDetail() {
                ...
                self.loading = true;
                self.$http({
                    url: self.$api.inquiry_v6_quotations + '/0/' + self.inquiryQuotationId,
                    type: 'GET',
                    success: function (data) {
                        self.loading = false;
                        self.inquiryQuotationDetail = data;
                        if (data.follower && data.follower.company && data.follower.company.account_company_id) {
                            self.forwardCompanyIds = [data.follower.company.account_company_id];
                            let company_ids = [9428,39567];
                            company_ids.push(data.follower.company.account_company_id);
                            self.getSendToUserList({
                                company_ids: company_ids.join(',')
                            }, () => {
                                if (data.follower.user) {
                                    self.fastTo({
                                        account_company_id: data.follower.company.account_company_id,
                                        company_name: data.follower.company.company_name,
                                        company_type: data.follower.company.company_type,
                                        account_user_id: data.follower.user.account_user_id,
                                        name: data.follower.user.name,
                                    })
                                }
                            })
                        }
    ...
    .related-message-detail {
        .related-message-detail-list {
            ...
            .message-item {
                ...
                .message-purple {
                    background-color: #b276e0 !important;
                }

                .message-green {
                    background-color: #5cc74e !important;
                }

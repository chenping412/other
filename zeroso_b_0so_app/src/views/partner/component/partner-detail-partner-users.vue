    ...
    <div class="partner-detail-partner-users clearfix" v-loading="loading">
        ...
        <div class="user-info" :style="{'width':listData.length===0?'100%':null}">
            <div class="padding-left-20 padding-bottom-20">
                ...
                <el-button type="primary" v-if="selectUserForm.id" @click="clickEditUser()">编辑</el-button>
                <el-button type="warning" plain v-if="selectUserForm.id && !selectUserForm.is_primary" @click="setDefault('set_primary')">设为推荐</el-button>
                <el-button type="warning" plain v-if="selectUserForm.id && selectUserForm.is_primary" @click="setDefault('unset_primary')">取消推荐</el-button>

                <partner-detail-partner-users-admin v-if="selectUserForm.id" :queryId="queryId" :userId="selectUserForm.id"></partner-detail-partner-users-admin>
                <partner-detail-partner-users-status-action v-if="selectUserForm.id" :queryId="queryId" :selectUserForm="selectUserForm" @update="init"></partner-detail-partner-users-status-action>
                ...
                <el-row :gutter="20">
                    <el-col :span="8">
                        ...
                        <el-form-item label="头像：">
                            <ImageShow ref="show_partner_avatar" :module_id="selectUserForm.id" module_name="partner_avatar" subsystem="partner"></ImageShow>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        ...
                        <el-form-item label="微信二维码：">
                            <ImageShow ref="show_wechat_qcode" :module_id="selectUserForm.id" module_name="wechat_qcode" subsystem="partner"></ImageShow>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
            ...
            <el-form v-if="selectUserForm.id" :model="bankAccount" :rules="bankAccountRule" ref="bankAccountForm" label-width="110px">
                <el-row :gutter="20">
                    <el-col :span="8">
                    ...
                    <el-col :span="8">
                        ...
                        <el-form-item label="国家：" prop="country">
                            ...
                            <span v-else class="form-border-bottom">{{bankAccount.country | country | defaultStr}}</span>
                        </el-form-item>
                        <el-form-item label="货币：" prop="currency">
                            ...
                            <span v-else class="form-border-bottom">{{bankAccount.currency | currency | defaultStr}}</span>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
                ...
                <el-row :gutter="20">
                    ...
                    <el-form-item label="部门">
                        ...
                        <el-form-item label="电话" prop="phone">
                            <InputPhone :value.sync="addForm.phone" :suffixPhone.sync="addForm.suffix_phone_number" :rules.sync="addFormRule.phone"></InputPhone>
                        </el-form-item>
                    <el-form-item label="性别">

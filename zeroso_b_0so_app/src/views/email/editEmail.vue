            ...
            <div class="content" v-loading="loading">
                <el-form :model="emailForm" :rules="emailFormRule" ref="emailForm" label-width="80px" label-position="left">
                    <el-form-item label="收件人：" prop="mail_to">
                        <div class="email-row">
                            <SelectEmailInput :email.sync="emailForm.mail_to" :multiple-limit="1" placeholder="请输入收件人邮箱"></SelectEmailInput>
                            <div class="append">
                    ...
                    <el-form-item label="抄送人：" prop="mail_cc" v-if="mailCcShow">
                        <div class="email-row">
                            <SelectEmailInput :email.sync="emailForm.mail_cc" placeholder="请输入抄送人邮箱"></SelectEmailInput>
                            <div class="append">
                    ...
                    <el-form-item label="密送人：" prop="mail_bcc" v-if="mailBccShow">
                        <div class="email-row">
                            <SelectEmailInput :email.sync="emailForm.mail_bcc" placeholder="请输入密送人邮箱"></SelectEmailInput>
                            <div class="append">

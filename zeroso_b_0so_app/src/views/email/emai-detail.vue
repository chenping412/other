            ...
            <div class="detail-base-info">
                <div class="detail-base-title">
                    <div class="detail-status">
                        ...
                        <el-button size="mini" plain class="margin-left-10" v-if="detailForm.module_name==='order' || detailForm.module_name==='inquiry_pool'" @click="updateEmaiData('/module',{},'DELETE')">解除绑定</el-button>
                ...
                <div class="detail-base-body">
                    ...
                    <div class="email-content" v-html="detailForm.message_body_html"></div>

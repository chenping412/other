<template>
    <div class="clearfix" v-loading="loading">
        ...
        <el-dialog title="供应商操作" :visible.sync="dialogShow" width="500px" :close-on-click-modal="false"
                   v-loading="loading">
    ...
    export default {
        ...
        methods: {
            ...
            getListData() {
                ...
                self.loading = true;
                self.$http({
                    url: self.$api.partner_relation_brands_v2 + '/' + self.queryId + '/supplier',
            ...
            clickSaveDate() {
                ...
                self.$refs.form.validate(function (valid) {
                    if (valid) {
                        self.loading = true;
                        self.$http({
                            url: self.addForm.relation_id ? self.$api.partner_brands_v2 + '/' + self.addForm.relation_id : self.$api.partner_relation_brands_v2 + '/' + self.queryId + '/supplier',

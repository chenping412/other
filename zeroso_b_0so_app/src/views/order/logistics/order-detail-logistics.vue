        ...
        <div class="container-content flex-item-scroll">
            ...
            <el-card class="margin-bottom-20" v-if="third_delivery_numbers.length>0">
                ...
                <div>
                    ...
                    <!--<div class="padding-top-10" v-if="third_delivery_numbers_checked">
                        ...
                        <el-timeline>
                            <el-timeline-item
                                ...
                                <div class="box-log-line clearfix" :class="{'blue font-weight-bold':$index===0}">
                                    <p class="box-log-line-col">{{logLine.create_time}}</p>
                                    <p class="box-log-line-col">{{logLine.action | logisticsActionName}}</p>
                                    <p class="box-log-line-col box-log-line-col2">{{logLine |
                                        zerosoLocationAndSchedule}}</p>
                                </div>
                            </el-timeline-item>
                        </el-timeline>
                    </div>

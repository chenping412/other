        ...
        <ul class="status-list clearfix">
            <template v-for="(chainNode,$index) in order_node_states">
                <li :key="$index" v-if="$index<order_node_states.length-1">
                    <el-button type="text"
                               :disabled="($index != currentIndex && $index != currentIndex - 1) || (orderData.merge_order_id && !mainCompanyAbbreviationCode[chainNode.account_company_id])"
                ...
                <el-step :key="$index">
                    <template slot="title">
                        ...
                        <p v-if="$index>0 && $index<order_node_states.length-1">
                            {{chainNode.account_company.company_name | mainCompanyAbbreviationCode(chainNode.account_company_id)}}
                        </p>
                    ...
                    <template slot="description">
                        <img class="step-box" v-if="chainNode.company_type !== 'internal' && $index===0 && ['waiting','partial'].indexOf(orderData.logistics_state)>-1" src="../../../assets/images/box.png">
                        <el-popover v-if="boxesLogistics[chainNode.account_company_id]" placement="bottom" width="500" trigger="hover">
                            <span class="step-box" slot="reference">
                                <img v-if="boxesLogistics[chainNode.account_company_id].length === 1" src="../../../assets/images/box.png">
                                <img v-if="boxesLogistics[chainNode.account_company_id].length > 1" src="../../../assets/images/boxes.png">
                            </span>
                            <div class="scroll" style="max-height:400px;">

                                <div class="padding-10" v-for="(box,$index) in boxesLogistics[chainNode.account_company_id]" :key="$index">

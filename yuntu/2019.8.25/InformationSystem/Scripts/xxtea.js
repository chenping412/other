...
var peakenkey = "1234567890abcdef";
...
/* 加密 */
var Xxtea_Encrypt = function (text) {
    var en = new Xxtea(peakenkey);
    return en.xxtea_encrypt(text);
};

/* 解密 */
var Xxtea_Decrypt = function (text) {
    var de = new Xxtea(peakenkey);
    return de.xxtea_decrypt(text);
};
  ...
  <div id="daka-examine">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">大咖管理</el-breadcrumb-item>
        <el-breadcrumb-item>申请审批列表</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="daka-exmine-main">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="待认证" name="dairenzheng">
        ...
        <el-tab-pane label="已通过" name="yitongguo">
          <div class="top clearfix">
            ...
            <!--<el-button type="primary" size="small" class="btn-remove">批量删除</el-button>-->
          </div>
          <div class="table-list">
            <el-table
              ref="multipleTable"
        ...
        <el-tab-pane label="未通过" name="weitongguo">
          <div class="top clearfix">
            <el-form :inline="true" :model="searchForm_1" class="demo-form-inline">
              <el-form-item label="请输入关键字">
                <el-input v-model="searchForm_1.keyword" placeholder="请输入关键字" size="small"></el-input>
        ...
        <el-tab-pane label="已屏蔽" name="yipingbi">
          <div class="top clearfix">
            <el-form :inline="true" :model="searchForm_2" class="demo-form-inline">
              <el-form-item label="请输入关键字">
                <el-input v-model="searchForm_2.keyword" placeholder="请输入关键字" size="small"></el-input>

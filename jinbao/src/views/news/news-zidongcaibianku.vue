<template>
  <div id="news-zidongcaibianku">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">资讯管理</el-breadcrumb-item>
        <el-breadcrumb-item>自动采编库</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="news-zidongcaibianku-main">
...
<style lang="less">
  #news-zidongcaibianku {
    .news-zidongcaibianku-main {
      .top {
        padding: 10px 0;

<template>
  <div id="news-neibugaojianku">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">资讯管理</el-breadcrumb-item>
        <el-breadcrumb-item>内部稿件库</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="news-neibugaojianku-main">
      <div class="top clearfix">
        ...
        <el-button type="primary" size="small" class="btn" @click="$router.push('/index/write-article')">写文章</el-button>
        <el-button type="primary" size="small" class="btn" @click="">批量发布</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      getInnerManuscript() {
        var self = this;
        $.ajax({
          url: self.apiHost + "/manage/article/list",
          type: "post",
          data: {},

<template>
  <div id="news-dakagaojianku">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">资讯管理</el-breadcrumb-item>
        <el-breadcrumb-item>大咖稿件库</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="news-dakagaojianku-main">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="大咖稿件库" name="first">用户管理</el-tab-pane>
        <el-tab-pane label="未通过" name="second">配置管理</el-tab-pane>
      </el-tabs>

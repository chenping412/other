<template>
  <div id="integral-type">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/' }">积分管理</el-breadcrumb-item>
        <el-breadcrumb-item>积分类型</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      getIntegralTypeList() {
        var self = this;
        $.ajax({
          url: self.apiHost + "/point/type/list",
          type: "post",
          data: {},
          success: function (data) {
            if (data.code == 0) {
              self.integralTypeList = data.data;
            }
          },
          error: function () {

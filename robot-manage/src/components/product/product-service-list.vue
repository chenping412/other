  ...
  <div id="order-list">
    ...
    <div class="table">
      <el-table :data="listData" style="width: 100%">
        ...
        <el-table-column prop="order_no" label="所属机器人" align="center"></el-table-column>
        <el-table-column prop="order_no" label="状态" align="center"></el-table-column>
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <router-link :to="{path: '/product/service/detail', query: {id: scope.row.id}}">详情</router-link>
          </template>
        </el-table-column>
      </el-table>
    </div>

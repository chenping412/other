	...
	<div class="main">
		...
		<div>
			<table width="680" border="0" cellspacing="0" style="position:relative;">
				<tr>
					<td>发送到：<span class="red">${supplyName!}</span></td>
		...
		<div>
			<table width="680" border="0" cellspacing="0" class="box">
				<tr>
					<td style="width: 12%;" align="center">订单编号</td>
					<td style="width: 12%;" align="center">酒店名称</td>
					<td style="width: 8%;" align="center">房型</td>
					<td style="width: 6%;" align="center">订单状态</td>
					...
					<td style="width: 5%;" align="center">成本</td>
					<td style="width: 5%;" align="center">应付</td>
					<td style="width: 5%;" align="center">已付</td>
					<td style="width: 8%;" align="center">制单人</td>
				</tr>
				<#if dataList?? && (dataList?size > 0)>
					<#list dataList as bill>
						<tr>
							<td style="width: 12%;" align="center"><span class="red">${bill.orderCode!}</span></td>
							...
							<td style="width: 6%;" align="center"><span class="red">${bill.orderStateText!}</span></td>
							...
							<td style="width: 5%;" align="center"><span class="red">${bill.basePrice!}</span></td>
							...
							<td style="width: 8%;" align="center"><span class="red">${bill.maker!}</span></td>
						</tr>
					</#list>
				</#if>
			</table>

	...
	<div class="finance-manage-wrap">
		...
		<div class="main-content">
			<div class="filter-bar " style="line-height: 54px;">
				<form id="queryAgentBillOffForm" action="listAgentBillOffPage" method="post">
					...
					<ul>
						...
						<li class="filter-bar-list" ><span class="filter-bar-list-title">客户</span>
							<input type="text" placeholder="请选择客户" name="orgName" id="agentName" value="${billOffQuery.orgName}" class="text w_140 c_666 ">
							<i class="iconfont  icon-downTriangle"></i>
							<input type="hidden" id="agentCode" name="orgCode" value="${billOffQuery.orgCode}"/>
						</li>
			...
			<div class="table-list">
				<div class="table-list-header" style="width:100%;">
					<ul class="clearfix">
						...
						<li style="width: 12%; text-align: center;">客户</li>
				...
				<div class="table-list-content clearfix" style="width:100%;">
					<c:if test="${not empty page}">
						<c:forEach items="${page.recordList}" var="billOffResponseDTO"
							varStatus="status">
...
<script type="application/javascript">
	...
	function reverse(billOffId) {
		...
		$.ajax({
			...
			url : '<%=basePath%>admin/agentBillController/reverse',

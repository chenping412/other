...
<%-- 			<shiro:hasPermission name="finance:orderLock:query"> --%>
			<div class="filter-bar ">
				<form id="queryReceivableProfitForm" action="receivableProfit" method="post">
					...
					<ul class="clearfix">
						...
						<li><a class="search-btn" href="javascript:listReceivableProfit();"><i
			...
			<div class="table-list">
				<div class="table-list-header">
					<ul class="clearfix">
						...
						<li style="width: 15%">间数</li>
						<li style="width: 15%">应收</li>
						<li style="width: 15%">应付</li>
						<li style="width: 15%">利润</li>
					</ul>
				</div>
					...
					<c:if test="${not empty page}">
						<c:forEach items="${page.recordList}" var="receivable"
							...
							<ul class="row clearfix">
								...
								<li style="width: 15%">${receivable.rooms}</li>
								<li style="width: 15%">${receivable.receivable}</li>
								<li style="width: 15%">${receivable.payable}</li>
								<li style="width: 15%">${receivable.profit}</li>
							</ul>
						</c:forEach>
					</c:if>
				</div>
...
$(function() {
	...
	initPagination(listReceivableProfit);
...
function listReceivableProfit() {
	$("#queryReceivableProfitForm").submit();
}

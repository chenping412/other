	...
	<div class="add-agent-wrap">
		<div class="breadcrumb">
			...
			<span>当前位置：</span> <a href="javascript:;">客户管理</a> <span>></span> <a
				href="javascript:;">新增客户</a>
		</div>
		<div class="main-content">
			<div class="section-wrap section-wrap-function">
				<div class="section-content">
					<h3>新增客户</h3>
					<form id="addAgentFrom" action="add" method="post"
						class="form-list">
						...
						<ul class="row">
							...
							<li class="list"><span>邮箱 ：</span><input type="text"
								...
								class="empty iconfont icon-ArtboardCopy"></i></li>
							<li class="list"><span>信用额度<i id="creditLineLi"
									class="colorYellow">*</i> ：</span><input type="text"
								id="creditLine" name="creditLine" placeholder="请输入信用额度"><i
								class="empty iconfont icon-ArtboardCopy"></i></li>
							<li class="list">
								<span>是否多币种 ：</span>
			...
			<div class="search-footer">
				<div style="float: right">
					...
					<a href="javascript:addAgent();" class="save">保存</a>
				</div>

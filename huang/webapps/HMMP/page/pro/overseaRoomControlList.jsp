...
<div class="roomcontrol-manage-wrap">
    ...
    <div class="main-content">
            ...
            <form id="roomControlForm" action="overseaQueryRoomControlList" method="post">
...
<%--                 <input type="hidden" id="pageSize" name="pageSize" value="<c:choose><c:when test='${empty roomControlRequestDTO.pageSize}'>5</c:when><c:otherwise>${roomControlRequestDTO.pageSize}</c:otherwise></c:choose>" /> --%>
                <ul>
                    <li class="filter-bar-list"><span class="filter-bar-list-title">供应商</span>
                        <input type="text" placeholder="请选择供应商" name="supplyName" id="supplyName" value="${roomControlRequestDTO.supplyName}" class="text w_140 c_666 ">
                    ...
                    <li class="filter-bar-list">
                        ...
                        <input id="cityName" type="text" placeholder="请选择城市" readonly value="<c:choose><c:when test='${empty roomControlRequestDTO.cityName}'>澳门</c:when><c:otherwise>${roomControlRequestDTO.cityName}</c:otherwise></c:choose>" />
                            <%--<i class="iconfont  icon-downTriangle"></i>--%>
                    ...
                    <li class="filter-bar-list"><span class="filter-bar-list-title">酒店</span>
                        <input type="text" placeholder="请选择酒店" name="hotelName" id="hotelName" value="${roomControlRequestDTO.hotelName}" class="text w_140 c_666 "><i class="empty iconfont icon-ArtboardCopy"></i>
                        <%--<i class="iconfont  icon-downTriangle"></i>--%>
                        <i class="empty iconfont icon-ArtboardCopy"></i>
                    </li>

                    <li class="filter-bar-list"><span class="filter-bar-list-title">开始日期</span>
                        <input type="text"  name="beginDate" id="beginDate" value="${roomControlRequestDTO.beginDate}" class="text w_140 c_666" autocomplete="off" />
                        <%--<i class="iconfont  icon-downTriangle"></i>--%>
                    </li>

                    <li class="filter-bar-list">
                        <span class="filter-bar-list-title">结束日期</span>
                        <input type="text"  name="endDate" id="endDate" value="${roomControlRequestDTO.endDate}" class="text w_140 c_666" autocomplete="off" />
                        <%--<i class="iconfont  icon-downTriangle"></i>--%>
                    </li>
                    <li class="filter-bar-list">
                ...
                <input type="hidden" id="cityCode" name="cityCode"  value="<c:choose><c:when test='${empty roomControlRequestDTO.cityCode}'>MAC</c:when><c:otherwise>${roomControlRequestDTO.cityCode}</c:otherwise></c:choose>" />
            </form>
            </shiro:hasPermission>
                        ...
                        <c:forEach items="${recordList}" var="dayRoomControl" varStatus="status">
                            <ul class="row clearfix"">
                                ...
                                <li style="width: 4%">
                                    ...
                                    <input type="hidden" value="${dayRoomControl.usedQuotaNum}" disabled readonly id="usedQuotaNum_${status.index}" style="width: 40px;">
                                </li>
                                <li style="width: 4%">
                                	<label>${empty dayRoomControl.quotaNum ? 0 : dayRoomControl.quotaNum}</label>
<%--                                     <input type="text" value="${dayRoomControl.quotaNum}" id="quotaNum_${status.index}" disabled readonly oninput="changeQuotaNum('${dayRoomControl.quotaNum}','${status.index}')" style="width: 50px; height: 22px;"> --%>
...
//     function savePriceAndQuota(saleDate,hotelId,pricePlanId,priceId,roomTypeId,quotaAccountId,quotaId,usedQuotaNum,roomTypeName,pricePlanName,index) {

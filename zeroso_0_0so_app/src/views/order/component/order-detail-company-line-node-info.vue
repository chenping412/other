...
<!--                        </el-button>-->
                ...
                <el-form :model="nodeForm" :rules="nodeFormRule" ref="nodeForm" label-width="130px" class="el-form-margin-small">
                    <el-row>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            ...
                            <el-form-item label="税率：">
                                <div v-if="isEdit">
                                    <el-select v-if="$index===0 && node.company_type !== 'internal'"
                                               v-model="nodeForm.tax_rate"
                                               :popper-append-to-body="false">
                                        <el-option value="19.00" label="19.00%"></el-option>
                                        <el-option value="16.00" label="16.00%"></el-option>
                                        <el-option value="0.00" label="0.00%"></el-option>
                                    </el-select>
                                    <InputNumber v-else :value.sync="nodeForm.tax_rate">
...
<!--                            </el-form-item>-->
                    ...
                    <el-row>
                        <el-col :span="12">
                            ...
                            <el-form-item label="B系统询报价单">
                                <span class="form-border-bottom">
                                    <router-link target="_blank" class="blue" :to="'/inquiry-quotation/all/detail?id='+node.inquiry_num" v-if="node.inquiry_num">
                                        {{node.inquiry_num | defaultStr}}
                                    </router-link>
                                </span>
                            </el-form-item>
                        </el-col>

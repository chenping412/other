        ...
        <div class="container-content flex-item-scroll">
            ...
            <el-card class="margin-bottom-20" v-if="isShowInvoice">
                <div class="order-control-search clearfix">
                    ...
                    <div class="item">
                        <el-button type="primary" @click="clickSearchWaitingInvoice">确定</el-button>
                    </div>
                    <div class="item">
                        <el-select v-model="searchForm.logistics_state" @change="clickSearchWaitingInvoice">
                        ...
                        <el-select v-model="searchForm.inbound_state" @change="clickSearchWaitingInvoice">
                        ...
                        <el-select v-model="searchForm.payment_method" @change="clickSearchWaitingInvoice">
                        ...
                        <el-select v-model="searchForm.supplier_invoice_state" @change="clickSearchWaitingInvoice">
                ...
                <div class="padding-top-20" v-if="totalCount > pageSize">
                    <el-pagination
                            @current-change="getAccountingWaitingInvoice"
                ...
                <el-card class="margin-bottom-20" :key="$index" v-if="isShowInvoice">
                    <div slot="header" class="clearfix">
                        <h3 class="left">
                            ...
                            <el-tag v-if="invoiceType==='customer'">{{orderNode.supplier_invoice_state|supplierInvoiceState}}</el-tag>
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                self.$http({
                    ...
                    success: function (data) {
                        ...
                        if (data.err_code.length === 0 && data.msg) {
                            ...
                            self.orderDetail.order_nodes.forEach((item,index)=>{
                                if(item.account_company_id===self.$store.state.currentCompany.account_company_id){
                                    if(self.invoiceType === 'supplier' && index-1>=0){
                                        self.currentNode=self.orderDetail.order_nodes[index-1];
                                    }else {
            ...
            clickSearchWaitingInvoice(){
                this.pageNum=1;
                this.getAccountingWaitingInvoice();
            },
            ...
            getQueryInvoice() {
                ...
                if(self.orderDetail.name && order_name.indexOf(self.orderDetail.name)===-1){
                    order_name.push(self.orderDetail.name)
                }
                self.loading=true;
                self.$http({

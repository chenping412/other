<template>
    <div v-loading="loading">
        ...
        <el-dialog title="银行账户操作" :visible.sync="dialogShow" width="700px" :close-on-click-modal="false"
                   v-loading="loading">
            ...
            clickSaveDate() {
                ...
                self.$refs.form.validate(function (valid) {
                    if (valid) {
                        self.loading = true;
                        self.$http({
                            url: self.addForm.id ? self.$api.bank_account_update + '/' + self.addForm.id : self.$api.bank_self_bank_account,

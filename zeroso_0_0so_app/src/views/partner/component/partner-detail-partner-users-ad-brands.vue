<template>
    <div>
        ...
        <el-dialog :title="actionDialogTitle || '推广品牌管理'" :visible.sync="dialogShow" width="700px" :close-on-click-modal="false" append-to-body  v-loading="loading">
            <el-form :model="editRowForm" :rules="editRowFormRule" ref="editRowForm" label-width="0">
                <el-table :data="listData" border v-loading="loading" max-height="550px" size="mini">
...
<script>
    export default {
        props:['userId','actionDialogTitle'],
        data() {
            return {
                loading:false,
                dialogShow:false,

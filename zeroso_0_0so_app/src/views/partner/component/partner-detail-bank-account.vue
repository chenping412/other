        ...
        methods: {
            ...
            clickSaveDate() {
                ...
                self.$refs.form.validate(function (valid) {
                    if (valid) {
                        if(self.addForm.account_number) self.addForm.account_number=self.addForm.account_number.replace(/ /g,'');
                        if(self.addForm.bic_code) self.addForm.bic_code=self.addForm.bic_code.replace(/ /g,'');
                        self.loading = true;
                        self.$http({

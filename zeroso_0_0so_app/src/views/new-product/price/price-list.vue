    ...
    <div id="" class="flex-box-column">
        <div class="container-control flex-item">
            <div class="control-bread">
                <el-breadcrumb>
                    <el-breadcrumb-item>产品中心 / 商品管理 / 价格表管理</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
            ...
            <div class="table-control clearfix">
                <div class="control-btns">
                    <el-button type="primary" @click="openDetail()">新增价格表</el-button>
                </div>
        ...
        <div class="container-content flex-item-scroll">
            <div class="container-table">
                <el-table :data="listData" @row-click="openDetail" border v-loading="loading">
                    ...
                    <el-table-column label="有效期开始时间" prop="validity_start_date"></el-table-column>
                    <el-table-column label="有效期结束时间" prop="validity_end_date"></el-table-column>
                    ...
                    <el-table-column label="状态">
                        <template slot-scope="scope">
                            <NewProductPriceState :state="scope.row.state"></NewProductPriceState>
                        </template>
                    </el-table-column>

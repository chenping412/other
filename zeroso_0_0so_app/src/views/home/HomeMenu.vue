            ...
            <template v-for="item1 in menuList">
                <el-submenu :index="item1.name" :key="item1.name" v-if="item1.show && item1.children">
                    ...
                    <template v-for="item2 in item1.children">
                        <el-submenu :index="item2.name" :key="item2.name" v-if="item2.show && item2.children">
                            <span slot="title" @click="menuClick(item2)">{{item2.name}}</span>
                            <template v-for="item3 in item2.children">
                                <el-menu-item :index="item3.index || item3.path"
                                              @click="menuClick(item3)"
                                              :key="item3.name">
                                    <span slot="title">
                        ...
                        <el-menu-item :index="item2.index || item2.path"
                                      ...
                                      :key="item2.name"
                                      v-if="item2.show && !item2.children">
                            <span slot="title">

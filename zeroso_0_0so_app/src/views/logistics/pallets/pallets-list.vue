    ...
    <div class="flex-box-column stockIn-list">
        <div class="container-control flex-item">
            <div class="control-bread">
                <el-breadcrumb>
                    <el-breadcrumb-item>库存 / 托盘列表</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
        ...
        <div class="container-content flex-item-scroll">
            ...
            <el-table :data="listData" @row-click="openDetail" border v-loading="loading">
                ...
                <el-table-column label="托盘号" prop="pallet_name"></el-table-column>
                <el-table-column label="所在仓">
                ...
                <el-table-column label="托盘状态">
                    <template slot-scope="scope">
                        {{scope.row.state | logisticsV4PalletState}}
                    </template>
                </el-table-column>
...
<script>
    ...
    export default {
        components: {StockOutAdd, BoxAdd, PalletsAdd},
        data() {
            return {
                listApi: this.$api.order_pallets + '/search',
                filterKey:'logistics_pallets',
                filter: {},

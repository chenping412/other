...
//合作伙伴等级
Vue.filter('companyLevel', function (value) {
    let str = '';
    store.state.companyLevel.forEach((item) => {
        if (item.code == value) {
            str = item.label;
        }
    });
...
Vue.filter('newBrandIdentityRule', function (value) {
    let str = '';
    store.state.newBrandIdentityRule.forEach((item) => {
        if (item.code == value) {
            str = item.label;
        }
    });
...
Vue.filter('productDetailSource', function (value) {
    let str = '';
    store.state.productDetailSource.forEach((item) => {
        if (item.code == value) {
            str = item.label;
        }
    });
...
Vue.filter('productType', function (value) {
    let str = '';
    store.state.productType.forEach((item) => {
        if (item.code == value) {
            str = item.label;
        }
    });
...
Vue.filter('wwwNewsType', function (value) {
    let str = '';
    store.state.wwwNewsType.forEach((item) => {
        if (item.code == value) {
            str = item.label;
        }
    });

    ...
    <div>
        <div class="control-item" v-for="(item,$index) in allowFilterFieldsList" :key="$index" :title="item.translate">
            ...
            <div class="item-content">
                ...
                <el-select v-if="item.fieldMudelType === 'selection'" v-model="item[item.field_name]" clearable filterable :placeholder="item.translate" @change="clickSearch">
                ...
                <SelectNewBrand v-if="item.fieldMudelType === 'new_brand'" :brand.sync="item[item.field_name]" :option="item[item.field_name]?[item[item.field_name]]:null" @change="clickSearch" :placeholder="item.translate"></SelectNewBrand>
                ...
                <SelectCompanyUser v-if="item.fieldMudelType === 'companyUser'" :user.sync="item[item.field_name]" :companyIds="item.companyIds" :option="item[item.field_name]?[item[item.field_name]]:null" :showNull="true" @change="clickSearch" :placeholder="item.translate"></SelectCompanyUser>
                ...
                <SelectAssistantAccount v-if="item.fieldMudelType === 'assistant_account'" :assistantAccount.sync="item[item.field_name]"  @change="clickSearch"></SelectAssistantAccount>
            </div>

...
Vue.prototype.$utils = {
    ...
    formatSearchFilterV6(list) {
        ...
        list.forEach((item)=>{
            if (Object.prototype.toString.call(item[2]) === '[object Object]') {
                filter[item[0]] = item[2].uid ||  item[2].id || item[2].account_user_id || item[2].account_company_id;
    ...
    //整理排序字段，新系统格式
    formatSearchSortV7(obj) {
        if (!obj || !obj.field_name) return {};
        return {
            order_by: obj.field_name + '_' + obj.by
        }
    },

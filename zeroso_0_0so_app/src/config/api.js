...
Vue.prototype.$api = {
  //登录页
    ...
    //新文件系统
    oss_file: HostConfig.ossHost + '/file',


    //品牌、产品相关
    product_brands: HostConfig.productHost + '/brands',
    ...
    product_v5 : HostConfig.productHost + '/v5',
    ...
    product_dict_message_template : HostConfig.productHost + '/dict/message_template',


    //新产品库
    new_product_basic_product_brand : HostConfig.productHost + '/basic/product/brand',
    new_product_basic_product_brand_list : HostConfig.productHost + '/basic/product/brand/list',
    new_product_basic_product_brand_q : HostConfig.productHost + '/basic/product/brand/q',
    new_product_basic_product_hs : HostConfig.productHost + '/basic/product/hs',
    new_product_basic_product_hs_list : HostConfig.productHost + '/basic/product/hs/list',
    new_product_basic_product_hs_q : HostConfig.productHost + '/basic/product/hs/q',
    new_product_basic_product_tariff : HostConfig.productHost + '/basic/product/tariff',
    new_product_basic_product_tariff_list : HostConfig.productHost + '/basic/product/tariff/list',
    new_product_basic_product_vat : HostConfig.productHost + '/basic/product/vat',
    new_product_basic_product_vat_list : HostConfig.productHost + '/basic/product/vat/list',
    new_product_basic_product_vat_q : HostConfig.productHost + '/basic/product/vat/q',
    new_product_catalog_product_brand : HostConfig.productHost + '/catalog/product/brand',
    new_product_catalog_product_catalog : HostConfig.productHost + '/catalog/product/catalog',
    new_product_catalog_product_catalog_list : HostConfig.productHost + '/catalog/product/catalog/list',
    new_product_catalog_product_template : HostConfig.productHost + '/catalog/product/template',
    new_product_catalog_product_template_export : HostConfig.productHost + '/catalog/product/template/export',
    new_product_catalog_product_product : HostConfig.productHost + '/catalog/product/product',
    new_product_price_product_product : HostConfig.productHost + '/price/product/product',
    new_product_basic_product_product_extend_field : HostConfig.productHost + '/basic/product/product/extend_field',
    new_product_basic_product_product_extend_field_list : HostConfig.productHost + '/basic/product/product/extend_field/list',
    new_product_price_product_catalog : HostConfig.productHost + '/price/product/catalog',
    new_product_price_product_catalog_list : HostConfig.productHost + '/price/product/catalog/list',
    new_product_price_product_template : HostConfig.productHost + '/price/product/template',
    new_product_price_product_template_export : HostConfig.productHost + '/price/product/template/export',
    new_product_basic_product_label_normal : HostConfig.productHost + '/basic/product/label/normal',
    new_product_basic_product_label_normal_list : HostConfig.productHost + '/basic/product/label/normal/list',
    new_product_basic_product_label_normal_q : HostConfig.productHost + '/basic/product/label/normal/q',
    new_product_basic_product_label_base_q : HostConfig.productHost + '/basic/product/label/base/q',
    ...
    inquiry_v6_0_quotations: HostConfig.inquiryHost+'/v6/0/quotations',


    //官网模块
    www_users_demands: HostConfig.wwwHost+'/api/0/users/demands',
    www_users_demands_list: HostConfig.wwwHost+'/api/0/users/demands/list',
    www_0_news: HostConfig.wwwHost+'/api/0/news',
    www_0_news_list: HostConfig.wwwHost+'/api/0/news/list',
    ding_talk_v1_departments: HostConfig.dingTalkHost+'/api/v1/departments',
};

<template>
  <div id="formula-list">
    ...
    <div class="control">
      <div class="item">
        <router-link class="btn" to="/formula/add">新增</router-link>
      </div>
      <div class="item">
        <span>时间：</span>
        <el-date-picker
      ...
      <el-table
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <router-link :to=" '/formula/add?id='+scope.row.id ">修改</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      deleteData: function (id) {
        var self = this;
        this.$confirm('您确定要删除公式么?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(function () {
          $.ajax({
            url: apiHost + '/formula/delete',
            data: {
              id: id
            },
            type: "GET",

<template>
  <div id="section-list">
    ...
    <div class="control">
      <div class="item">
        <router-link class="btn" to="/section/add">新增</router-link>
      </div>
      <div class="item">
        <span>时间：</span>
        <el-date-picker
    ...
    <div class="table">
      <el-table
        ...
        <el-table-column prop="name" label="段落名称" width="150"></el-table-column>
        <el-table-column prop="description" label="描述" show-overflow-tooltip></el-table-column>
        <el-table-column prop="createTime" label="录入时间"></el-table-column>
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <router-link :to=" '/section/add?id='+scope.row.id ">修改</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      deleteData: function (id) {
        var self = this;
        this.$confirm('您确定要删除段落么?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(function () {
          $.ajax({
            url: apiHost + '/section/delete',
            data: {
              id: id
            },
            type: "GET",

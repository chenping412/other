<template>
  <div id="datasource-list">
    ...
    <div class="control">
      <div class="item">
        <router-link class="btn" to="/datasource/add">新增</router-link>
      </div>
      <div class="item">
        <span>时间：</span>
        <el-date-picker
      ...
      <el-table
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            <router-link :to=" '/datasource/add?id='+scope.row.id ">修改</router-link>
  ...
  export default {
    ...
    methods: {
      ...
      deleteData: function (id) {
        var self = this;
        this.$confirm('您确定要删除数据源么?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(function () {
          $.ajax({
            url: apiHost + '/datasource/delete',
            data: {
              id: id
            },
            type: "GET",
